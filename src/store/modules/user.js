...
const user = {
  ...
  actions: {
    ...
    LoginByUsername({commit}, userInfo) {
        console.log('encrypt(userInfo.password)', encrypt(userInfo.password))
    ...
    LoginByPhone({ commit }, userInfo) {
      return new Promise((resolve, reject) => {
        loginByPhone(userInfo.tenantId, encrypt(userInfo.phone), userInfo.codeId, userInfo.codeValue).then(res => {
          const data = res.data;
          if (data.error_description) {
            Message({
              message: data.error_description,
