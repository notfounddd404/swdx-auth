...
<script>
  import {getList, getDetail, add, update, remove, udpateLoginTopic} from "@/api/system/clientapply";
  ...
  export default {
    ...
    methods: {
      ...
      udpateLoginTopic() {
        ...
        udpateLoginTopic(this.loginTopicId,this.ids).then((res)=> {
