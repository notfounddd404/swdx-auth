...
<script>
  import {getList, getDetail, add, update, remove, removeLoginTopic} from "@/api/system/clientapply";
  ...
  export default {
    ...
    methods: {
      ...
      onLoad(page, params = {}, done = ()=>{}) {
        this.loading = true;
        console.log("loginTopicId",this.loginTopicId)
        params.loginTopic = this.loginTopicId
      ...
      removeLoginTopic() {
        removeLoginTopic(this.ids).then((res)=> {
